...
class Vista_lista_apuestas(QWidget):
    ...
    def aniadir_apuesta(self):
        ...
        if dialogo.resultado == 1:
            resultado = self.interfaz.aniadir_apuesta(str(dialogo.combobox_competidores.currentText()), dialogo.texto_valor.text(), str(dialogo.combobox_apostadores.currentText()))
            if resultado != "":
